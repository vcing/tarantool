...
test:execsql([[
	...
	INSERT INTO t1 VALUES (1, 1, 1, 'a'), (2, 2, 2, 'b');
	INSERT INTO t1 VALUES (3, 3, 3, 'c'), (4, 4, 4, 'd');
...
test:do_execsql_test(
	...
	{
	0, 0, 'A', 0, 'BINARY', 1, 'INT', 1, 1, 'B', 0, 'BINARY', 1, 'INT',
	})
...
test:do_execsql_test(
	...
	{
	0, 0, 'A', 0, 'BINARY', 1, 'INT', 1, 1, 'B', 0, 'BINARY', 1, 'INT', 2,
	2, 'C', 0, 'BINARY', 1, 'INT',
	})
...
test:do_execsql_test(
	...
	{
	0, 1, 'B', 0, 'BINARY', 1, 'INT', 1, 2, 'C', 0, 'BINARY', 1, 'INT',
	})
