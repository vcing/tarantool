...
test:do_execsql_test(
    ...
    [[
        ...
        CREATE TABLE t1(x INTEGER PRIMARY KEY, y INT , z INT );
...
test:do_execsql_test(
    ...
    [[
        DROP TABLE IF EXISTS t1;
        CREATE TABLE t1(i INTEGER PRIMARY KEY, a INT , b INT );
...
test:do_execsql_test(
    ...
    [[
        ...
        CREATE TABLE t4(col0  INT PRIMARY KEY, col1 INT );
...
test:do_execsql_test(
    ...
    [[
        DROP TABLE IF EXISTS t4;
        CREATE TABLE t4(col0 INT , col1 INT , pk  INT PRIMARY KEY);
