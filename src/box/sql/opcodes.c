...
const char *sqlite3OpcodeName(int i){
 static const char *const azName[] = {
    ...
    /*  79 */ "ResultTuple"      OpHelp("output=tuple(cursor(P1))"),
    ...
    /* 120 */ "SInsert"          OpHelp("space id = P1, key = r[P2]"),
    /* 121 */ "SDelete"          OpHelp("space id = P1, key = r[P2]"),
    /* 122 */ "SIDtoPtr"         OpHelp("space id = P1, space[out] = r[P2]"),
    /* 123 */ "IdxDelete"        OpHelp("key=r[P2@P3]"),
    /* 124 */ "Clear"            OpHelp("space id = P1"),
    /* 125 */ "ResetSorter"      OpHelp(""),
    /* 126 */ "ParseSchema2"     OpHelp("rows=r[P1@P2]"),
    /* 127 */ "ParseSchema3"     OpHelp("name=r[P1] sql=r[P1+1]"),
    /* 128 */ "RenameTable"      OpHelp("P1 = root, P4 = name"),
    /* 129 */ "LoadAnalysis"     OpHelp(""),
    /* 130 */ "DropTable"        OpHelp(""),
    /* 131 */ "DropIndex"        OpHelp(""),
    /* 132 */ "DropTrigger"      OpHelp(""),
    /* 133 */ "Param"            OpHelp(""),
