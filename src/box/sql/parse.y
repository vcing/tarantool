...
unsignednumbertypedef(A) ::= FLOAT|REAL|DOUBLE . {A.type = SQLITE_AFF_REAL;}
unsignednumbertypedef(A) ::= INT|INTEGER . {A.type = SQLITE_AFF_INTEGER; A.n.size = 16; A.n.precision = 0; }

%type numlengthtypedef {TypeDef}
unsignednumbertypedef(A) ::= DECIMAL|NUMERIC|NUM numlengthtypedef(B) . {A.type = SQLITE_AFF_REAL; A.n = B.n; }
